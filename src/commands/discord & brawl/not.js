...
module.exports = {
  name: "not",
  description: "List all members that are not in a team, that do not have a discord bound to them and that are not in the club but are in the discord.",
  slashBuilder() {
  ...
  async execute(interaction) {
    ...
    let embed = new Discord.EmbedBuilder()
      .setTitle("Members not in a team/not bound to a discord account/not in the club.")
    ...
    if (noClub != "") embed.addFields({ name: "Members not in the club", value: noClub });
